...
const GetHrefWithRedirect = href => href.includes(window.location.origin) || href.includes('canerozdemircgi.github.io') ? href : `${window.location.origin + window.location.pathname.replace('index.html', '')}redirect.html?address=${href}`;
...
<span class='limiter-page_items-bottom' style='grid-auto-rows: ${element_height};'>
	...
	get #items_max() { return Number(this.getAttribute('items_max')); }
	get #element_height() { return this.getAttribute('element_height'); }

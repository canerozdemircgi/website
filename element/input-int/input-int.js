...
class InputInt extends HTMLElement
{
	...
	{
return `\
<button id='${id}_InputIntButtonB' class='input-int-button-b' style='width: ${width_button};'>
	<svg class='input-int-img' width='10' height='10'>
		<use href='resource/button/Caret - Left.svg#Caret - Left'></use>
	</svg>
</button>
<input id='${id}_InputIntInput' class='input-int-input' type='text' value='${value}' style='width: ${width_input};'>
<button id='${id}_InputIntButtonN' class='input-int-button-n' style='width: ${width_button};'>
	<svg class='input-int-img' width='10' height='10'>
	...
	constructor()
	{
		...
		this.#node_button_b = document.getElementById(`${this.#id}_InputIntButtonB`);
		this.#node_button_b.addEventListener('click', () => { this.value -= 1; });

		this.#node_input = document.getElementById(`${this.#id}_InputIntInput`);
		this.#node_input.addEventListener('change', () => { this.value = this.#node_input.value; });

		this.#node_button_n = document.getElementById(`${this.#id}_InputIntButtonN`);
